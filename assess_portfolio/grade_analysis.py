...
portfolio_test_cases = [
    ...
    inputs=dict(
        ...
        symbol_allocs=OrderedDict(
            [('ABI', 0.049792531120331947), ('RRD', 0.029045643153526972), ('KLAC', 0.17634854771784231),
             ('PCL', 0.070539419087136929), ('JNY', 0.045643153526970952), ('JWN', 0.15767634854771784),
             ('PCP', 0.13900414937759337), ('CVH', 0.17634854771784231), ('JAVA', 0.14937759336099585),
             ('PTV', 0.0062240663900414933)]),
        start_val=1520812,
        risk_free_rate=0.44),
    outputs=dict(
...
PortfolioTestCase(
    inputs=dict(
        ...
        end_date='2012-09-12',
        symbol_allocs=OrderedDict(
            [('MDT', 0.06699346405228758), ('MWW', 0.12254901960784316), ('CHK', 0.11928104575163399),
             ('FDX', 0.10130718954248367), ('VAR', 0.09477124183006537), ('V', 0.16339869281045755),
             ('ESRX', 0.13398692810457516), ('ATI', 0.017973856209150329), ('BDK', 0.047385620915032685),
             ('WB', 0.13235294117647062)]),
        start_val=1677213,
        risk_free_rate=0.06),
    outputs=dict(
...
PortfolioTestCase(
    inputs=dict(
        ...
        end_date='2012-09-12',
        symbol_allocs=OrderedDict(
            [('DLTR', 0.021594684385382059), ('NBR', 0.13122923588039867), ('UNP', 0.1395348837209302),
             ('AIG', 0.10631229235880398), ('M', 0.078073089700996662), ('FLIR', 0.083056478405315604),
             ('X', 0.1395348837209302), ('SPY', 0.088039867109634545), ('PTV', 0.096345514950166106),
             ('BDK', 0.11627906976744184)]),
        start_val=1910576,
        risk_free_rate=0.26),
    outputs=dict(
