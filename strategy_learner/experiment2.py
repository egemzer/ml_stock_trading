...
def benchmark(start_val = 100000, benchmarkSymbol = "JPM", commission = 0.00, impact = 0.005, num_shares = 1000, sd=dt.datetime(2008, 1, 1), ed=dt.datetime(2009, 12, 31)):
    ...
    plt.legend(loc="best")
    plt.title("In-Sample Normed Returns: Benchmark vs Learner")
    plt.savefig('experiment2insample.png')
    plt.switch_backend('Agg')
    ...
    plt.ylabel("Cumulative return (%)")
    plt.legend(loc="best")
    plt.title("Out-of-Sample Normed Returns: Benchmark vs Learner")
    plt.savefig('experiment2outofsample.png')
    plt.switch_backend('Agg')
...
if __name__=="__main__":
    benchmark(start_val = 100000, benchmarkSymbol = "JPM", commission = 0.00,
              impact = 0.005, num_shares = 1000, sd=dt.datetime(2008, 1, 1), ed=dt.datetime(2009, 12, 31))
