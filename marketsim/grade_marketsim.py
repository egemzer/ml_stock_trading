...
marketsim_test_cases = [
    ...
    MarketsimTestCase(
        description='additional_orders : rhunter 0',
        group='both',
        inputs=dict(
        ...
        outputs=dict(
            num_days=232,
            last_day_portval=1051088.0915,
            sharpe_ratio=0.552604907987,
            avg_daily_ret=0.000253483085898
        )
    ),


    MarketsimTestCase(
        description='additional_orders : rhunter 1',
        group='both',
        inputs=dict(
            orders_file='../additional_orders/orders.csv',
            start_val=1000000,
            commission=9.95,
            impact=0.005
        ),
        outputs=dict(
            num_days=240,
            last_day_portval=1106025.8065,
            sharpe_ratio=0.997654521878,
            avg_daily_ret=0.000459098655493
        )
    ),


    MarketsimTestCase(
        description='additional_orders : rhunter 2',
        group='both',
        inputs=dict(
        ...
        outputs=dict(
            num_days=11,
            last_day_portval=993036.375,
            sharpe_ratio=-1.00015025363,
            avg_daily_ret=-0.000427210193308
        )
    ),
    #########################
    ...
    MarketsimTestCase(
        description='testcases_mc2p1 : rhunter 0',
        group='both',
        inputs=dict(
            orders_file='orders-01.csv',
            start_val=1000000,
        ...
        outputs=dict(
            num_days=245,
            last_day_portval=1073672.2505,
            sharpe_ratio=0.444802967203,
            avg_daily_ret=0.000408504037065
        )
    ),


    MarketsimTestCase(
        description='testcases_mc2p1 : rhunter 1',
        group='both',
        inputs=dict(
            orders_file='orders-02.csv',
            start_val=1000000,
        ...
        outputs=dict(
            num_days=245,
            last_day_portval=1064130.02375,
            sharpe_ratio=0.752216030982,
            avg_daily_ret=0.00029517581912
        )
    ),


    MarketsimTestCase(
        description='testcases_mc2p1 : rhunter 2',
        group='both',
        inputs=dict(
            orders_file='orders-03.csv',
            start_val=1000000,
        ...
        outputs=dict(
            num_days=240,
            last_day_portval=832578.123,
            sharpe_ratio=-0.89161101288,
            avg_daily_ret=-0.000681963068203
        )
    ),


    MarketsimTestCase(
        description='testcases_mc2p1 : rhunter 3',
        group='both',
        inputs=dict(
            orders_file='orders-04.csv',
            start_val=1000000,
        ...
        outputs=dict(
            num_days=233,
            last_day_portval=897088.496,
            sharpe_ratio=-0.3771916002,
            avg_daily_ret=-0.000347224835936
        )
    ),


    MarketsimTestCase(
        description='testcases_mc2p1 : rhunter 4',
        group='both',
        inputs=dict(
            orders_file='orders-05.csv',
            start_val=1000000,
        ...
        outputs=dict(
            num_days=296,
            last_day_portval=1398568.185,
            sharpe_ratio=2.11546167579,
            avg_daily_ret=0.00118146821719
        )
    ),


    MarketsimTestCase(
        description='testcases_mc2p1 : rhunter 5',
        group='both',
        inputs=dict(
            orders_file='orders-06.csv',
            start_val=1000000,
        ...
        outputs=dict(
            num_days=210,
            last_day_portval=881616.422,
            sharpe_ratio=-1.37160681167,
            avg_daily_ret=-0.000574869353191
        )
    ),


    MarketsimTestCase(
        description='testcases_mc2p1 : rhunter 6',
        group='both',
        inputs=dict(
            orders_file='orders-07.csv',
            start_val=1000000,
        ...
        outputs=dict(
            num_days=237,
            last_day_portval=1100031.151,
            sharpe_ratio=1.98406389811,
            avg_daily_ret=0.000409716050612
        )
    ),


    MarketsimTestCase(
        description='testcases_mc2p1 : rhunter 7',
        group='both',
        inputs=dict(
            orders_file='orders-08.csv',
            start_val=1000000,
        ...
        outputs=dict(
            num_days=229,
            last_day_portval=1065969.537,
            sharpe_ratio=0.834375322416,
            avg_daily_ret=0.000296843482856
        )
    ),


    MarketsimTestCase(
        description='testcases_mc2p1 : rhunter 8',
        group='both',
        inputs=dict(
            orders_file='orders-09.csv',
            start_val=1000000,
        ...
        outputs=dict(
            num_days=37,
            last_day_portval=1035078.2,
            sharpe_ratio=1.92782122337,
            avg_daily_ret=0.00124838519675
        )
    ),


    MarketsimTestCase(
        description='testcases_mc2p1 : rhunter 9',
        group='both',
        inputs=dict(
            orders_file='orders-10.csv',
            start_val=1000000,
    ...
    MarketsimTestCase(
        description='testcases_mc2p1 : rhunter 10',
        group='both',
        inputs=dict(
            orders_file='orders-11.csv',
            start_val=1000000,
        ...
        outputs=dict(
            num_days=37,
            last_day_portval=1009959.8,
            sharpe_ratio=0.786130895625,
            avg_daily_ret=0.000581215856615
        )
    ),


    MarketsimTestCase(
        description='testcases_mc2p1 : rhunter 11',
        group='both',
        inputs=dict(
            orders_file='orders-12.csv',
            start_val=1000000,
        ...
        outputs=dict(
            num_days=240,
            last_day_portval=1705547.3665,
            sharpe_ratio=1.2640874971,
            avg_daily_ret=0.00290227121209
        )
    ),
